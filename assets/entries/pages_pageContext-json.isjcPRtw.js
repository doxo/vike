...
`,e.jsxs(n.p,{children:["You can also use ",e.jsxs(s,{href:"/passToClient#once",children:["the ",e.jsx(n.code,{children:"once"})," setting of ",e.jsx(n.code,{children:"passToClient"})]})," to send a ",e.jsx(n.code,{children:"pageContext"})," property to the client only once."]}),`
