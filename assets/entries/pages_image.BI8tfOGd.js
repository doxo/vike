import{o as t,a}from"../chunks/chunk-BxEkFozN.js";import{j as e}from"../chunks/chunk-BWBMLLro.js";import{L as l}from"../chunks/chunk-3WTzxuX3.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{M as o}from"../chunks/chunk-DiJVBdgr.js";import{P as i}from"../chunks/chunk-Qc9Dg_uq.js";/* empty css                      *//* empty css                      */import"../chunks/chunk-DfQe0O1c.js";/* empty css                      */const d=[{pageSectionId:"under-the-hood",pageSectionLevel:2,pageSectionTitle:"Under the hood"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(s){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["TypeScript: ",e.jsx(n.code,{children:"string | null | ((pageContext) => string | null | undefined)"}),e.jsx(n.br,{}),`
...
`]}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"image"})," setting sets the ",e.jsx(n.a,{href:"https://ahrefs.com/blog/open-graph-meta-tags",children:"preview image upon URL sharing"}),"."]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:[`It adds
`,e.jsx(n.a,{href:"https://ogp.me",children:e.jsx(n.code,{children:'<meta property="og:image">'})}),` (preview image upon URL sharing)
and
`,e.jsx(n.a,{href:"https://developer.x.com/en/docs/x-for-websites/cards/overview/summary-card-with-large-image",children:e.jsx(n.code,{children:'<meta name="twitter:card" content="summary_large_image">'})}),`
to `,e.jsx(n.code,{children:"<head>"}),":"]}),`
...
`]}),`
`,e.jsxs(n.p,{children:["You can set its value using a ",e.jsx(l,{href:"/pageContext",children:e.jsx(n.code,{children:"pageContext"})})," function:"]}),`
