import{o as r,a as i}from"../chunks/chunk-BxEkFozN.js";import{j as e}from"../chunks/chunk-BWBMLLro.js";import{L as s}from"../chunks/chunk-3WTzxuX3.js";/* empty css                      */import{W as o}from"../chunks/chunk-DseGLb9u.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */const t=[{pageSectionId:"once",pageSectionLevel:2,pageSectionTitle:"`once`"},{pageSectionId:"default",pageSectionLevel:2,pageSectionTitle:"Default"},{pageSectionId:"serialization",pageSectionLevel:2,pageSectionTitle:"Serialization"},{pageSectionId:"escape",pageSectionLevel:2,pageSectionTitle:"Escape `.`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["TypeScript: ",e.jsx(n.code,{children:"(string | { prop: string; once?: boolean })[]"}),e.jsx(n.br,{}),`
`,e.jsx(s,{href:"/config#cumulative",children:"Cumulative"}),": true",e.jsx(n.br,{}),`
...
`,e.jsx("h2",{id:"once",children:e.jsx("code",{children:"once"})}),`
`,e.jsx(o,{children:"This is a beta feature: expect breaking changes in any minor version update. If we don't encounter issues over the next 1–2 months, we'll remove this warning and consider the feature stable."}),`
`,e.jsxs(n.p,{children:["By default, upon ",e.jsx(s,{href:"/client-routing",children:"client-side navigation"}),", properties are passed to the client again."]}),`
`,e.jsxs(n.p,{children:["By setting ",e.jsx(n.code,{children:"once: true"}),", the property is sent only once, at the beginning of the user's browsing session. The sent value is cached (saved in the ",e.jsx(s,{href:"/globalContext",children:e.jsx(n.code,{children:"globalContext"})}),") and re-used on each subsequent client-side navigation."]}),`
`,e.jsx(n.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(n.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(n.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// /pages/+config.js"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"// Environment: config"})}),`
`,e.jsx(n.span,{"data-line":"",children:" "}),`
`,e.jsxs(n.span,{"data-line":"",children:[e.jsx(n.span,{style:{color:"#D73A49"},children:"export"}),e.jsx(n.span,{style:{color:"#D73A49"},children:" default"}),e.jsx(n.span,{style:{color:"#24292E"},children:" {"})]}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"  passToClient: ["})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#24292E"},children:"    {"})}),`
`,e.jsx(n.span,{"data-line":"",children:e.jsx(n.span,{style:{color:"#6A737D"},children:"      // pageContext.user"})}),`
...
`,e.jsxs(n.p,{children:["See also: ",e.jsx(s,{href:"/auth"})]}),`
`]}),`
`,e.jsxs(n.p,{children:["This is typically used to avoid ",e.jsx(s,{href:"/pageContext.json",children:e.jsx(n.code,{children:"pageContext.json"})})," requests upon client-side navigation."]}),`
