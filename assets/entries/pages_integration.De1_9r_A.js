...
`,e.jsx(n.p,{children:"You can manually integrate Vike into your server for full control over the server and deployment."}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["We generally recommend ",e.jsxs(s,{href:"/server",children:["using ",e.jsx(n.code,{children:"vike-server"})]}),", which automatically integrates Vike with your favorite JavaScript server (Express.js, Hono, Fastify, ...). But you can also manually integrate Vike if you need more control."]}),`
`]}),`
`,e.jsx(o,{}),`
`,e.jsxs(n.blockquote,{children:[`
