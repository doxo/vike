import{o as t,a as i}from"../chunks/chunk-BxEkFozN.js";import{j as e}from"../chunks/chunk-BWBMLLro.js";import{L as s}from"../chunks/chunk-3WTzxuX3.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{U as r}from"../chunks/chunk-DfQe0O1c.js";import{P as o}from"../chunks/chunk-Qc9Dg_uq.js";/* empty css                      *//* empty css                      *//* empty css                      */const d=[{pageSectionId:"global",pageSectionLevel:2,pageSectionTitle:"Global"},{pageSectionId:"multiple",pageSectionLevel:2,pageSectionTitle:"Multiple"},{pageSectionId:"nested",pageSectionLevel:2,pageSectionTitle:"Nested"},{pageSectionId:"data-fetching",pageSectionLevel:2,pageSectionTitle:"Data fetching"},{pageSectionId:"pagecontext",pageSectionLevel:2,pageSectionTitle:"`pageContext`"},{pageSectionId:"without-vike-react-vue-solid",pageSectionLevel:2,pageSectionTitle:"Without `vike-{react,vue,solid}`"},{pageSectionId:"the-simple-way",pageSectionLevel:4,pageSectionTitle:"The simple way"},{pageSectionId:"with-a-custom-setting",pageSectionLevel:4,pageSectionTitle:"With a custom setting"},{pageSectionId:"nested-layout",pageSectionLevel:4,pageSectionTitle:"Nested Layout"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function a(l){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["Environment: client, and server if ",e.jsx(s,{href:"/ssr",children:e.jsx(n.code,{children:"ssr: true"})}),e.jsx(n.br,{}),`
`,e.jsx(s,{href:"/config#cumulative",children:"Cumulative"}),": true",e.jsx(n.br,{}),`
`,e.jsx(s,{href:"/config#global",children:"Global"}),": false"]}),`
`,e.jsxs(o,{children:["the ",e.jsx(n.code,{children:"+Layout"})," setting"]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"What are layouts?"})}),`
`,e.jsxs(n.p,{children:["Pages usually share a common visual design. The ",e.jsx(n.code,{children:"+Layout"})," setting enables you to define such shared visual appearance."]}),`
`,e.jsx(n.p,{children:"You can also define multiple designs: some pages can share a design while other pages share another one. (For example, admin pages and marketing pages typically have a different design.)"}),`
`]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["If you want to add a wrapper component that is required for installing a tool, then we generally recommend using ",e.jsx(s,{href:"/Wrapper",children:e.jsx(n.code,{children:"<Wrapper>"})})," instead."]}),`
`]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["The reason ",e.jsx(n.code,{children:"/pages/+Layout.jsx"})," applies to all pages is explained at ",e.jsx(s,{href:"/config#inheritance"}),"."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["The following is for users that don't use a ",e.jsx(r,{}),"."]}),`
