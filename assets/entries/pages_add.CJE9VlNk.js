...
`]}),`
`]}),`
`,e.jsxs(i.li,{children:["add a ",e.jsx(s,{href:"/express",children:"Express.js"}),"/",e.jsx(s,{href:"/hono",children:"Hono"}),"/",e.jsx(s,{href:"/fastify",children:"Fastify"}),"/",e.jsx(s,{href:"/server",children:"..."})," server (or add ",e.jsx(s,{href:"/renderPage",children:"Vike's server middleware"})," if you already have one).",`
`,e.jsxs(i.blockquote,{children:[`
