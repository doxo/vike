import{o as c,a}from"../chunks/chunk-BxEkFozN.js";import{j as e}from"../chunks/chunk-BWBMLLro.js";import{L as n}from"../chunks/chunk-3WTzxuX3.js";/* empty css                      */import{W as o}from"../chunks/chunk-DseGLb9u.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{P as i}from"../chunks/chunk-Qc9Dg_uq.js";/* empty css                      *//* empty css                      *//* empty css                      */import"../chunks/chunk-DfQe0O1c.js";/* empty css                      */const t=[{pageSectionId:"cumulative",pageSectionLevel:2,pageSectionTitle:"Cumulative"},{pageSectionId:"script",pageSectionLevel:2,pageSectionTitle:"`<script>`"},{pageSectionId:"vue",pageSectionLevel:3,pageSectionTitle:"Vue"},{pageSectionId:"pagecontext",pageSectionLevel:2,pageSectionTitle:"`pageContext`"},{pageSectionId:"how-to-inject-raw-html",pageSectionLevel:2,pageSectionTitle:"How to inject raw HTML?"},{pageSectionId:"react",pageSectionLevel:3,pageSectionTitle:"React"},{pageSectionId:"vue",pageSectionLevel:3,pageSectionTitle:"Vue"},{pageSectionId:"solid",pageSectionLevel:3,pageSectionTitle:"Solid"},{pageSectionId:"only-html",pageSectionLevel:2,pageSectionTitle:"Only HTML"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function r(l){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["Environment: server",e.jsx(s.br,{}),`
...
`,e.jsxs(s.p,{children:["See ",e.jsx(n,{href:"/head-tags"})," for a general introduction about ",e.jsx(s.code,{children:"<head>"})," tags."]}),`
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["See also the ",e.jsxs(n,{href:"/useConfig#config-head",children:[e.jsx(s.code,{children:"<Head>"})," component"]})," (not to be confused with the ",e.jsx(s.code,{children:"+Head"})," setting)."]}),`
`]}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"link"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" rel"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"apple-touch-icon"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" href"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#24292E"},children:"{iconMobile} "}),e.jsx(s.span,{style:{color:"#6F42C1"},children:"type"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"image/svg+xml"'}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    {"}),e.jsx(s.span,{style:{color:"#6A737D"},children:"/* Add script tag */"}),e.jsx(s.span,{style:{color:"#24292E"},children:"}"})]}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    {"}),e.jsx(s.span,{style:{color:"#6A737D"},children:"/* More Open Graph tags */"}),e.jsx(s.span,{style:{color:"#24292E"},children:"}"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"meta"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" property"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"og:type"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" content"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"website"'}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"meta"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" property"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"article:author"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" content"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"https://example.com/author"'}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    {"}),e.jsx(s.span,{style:{color:"#6A737D"},children:"/* Settings for search engine crawlers */"}),e.jsx(s.span,{style:{color:"#24292E"},children:"}"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"meta"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" name"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"robots"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" content"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"index, follow"'}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    {"}),e.jsx(s.span,{style:{color:"#6A737D"},children:"/* PWA settings */"}),e.jsx(s.span,{style:{color:"#24292E"},children:"}"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"meta"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" name"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"theme-color"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" content"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"#00f"'}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"link"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" rel"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"manifest"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" href"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"/manifest.webmanifest"'}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    {"}),e.jsx(s.span,{style:{color:"#6A737D"},children:"/* CSP setting */"}),e.jsx(s.span,{style:{color:"#24292E"},children:"}"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"meta"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" http-equiv"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"Content-Security-Policy"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" content"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:`"script-src 'self'"`}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"  </>"})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"+Head"})," setting ",e.jsx(s.strong,{children:"only applies to the HTML of the first page the user visits"})," — it doesn't update upon client-side navigation. Therefore, you should use ",e.jsx(s.code,{children:"+Head"})," only for ",e.jsx(s.code,{children:"<head>"})," tags that are:"]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsx(s.li,{children:"Global (e.g. favicon and PWA settings) — their value is the same across all pages and therefore doesn't need to be updated upon navigation."}),`
`,e.jsx(s.li,{children:"Page-specific but intended for crawlers (e.g. SEO and SMO tags) — since crawlers extract information from the HTML of pages."}),`
`]}),`
`,e.jsx(s.p,{children:"For example:"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:["You cannot use ",e.jsx(s.code,{children:"+Head"})," for ",e.jsx(s.code,{children:"<title>"})," (use ",e.jsx(n,{href:"/title",children:e.jsx(s.code,{children:"+title"})})," instead), because ",e.jsx(s.code,{children:"<title>"})," sets the title shown in the user's browser tab which typically changes upon client-side navigation."]}),`
`,e.jsxs(s.li,{children:["You can use ",e.jsx(s.code,{children:"+Head"})," for ",e.jsx(s.code,{children:'<meta property="og:image">'}),", as it's intended for crawlers (e.g. Bluesky, Twitter)."]}),`
`,e.jsxs(s.li,{children:["You can use ",e.jsx(s.code,{children:"+Head"})," for ",e.jsx(s.code,{children:'<meta name="description">'}),", as it's also for crawlers (e.g. Google)."]}),`
`]}),`
`,e.jsxs(s.p,{children:["For a more detailed explanation, see ",e.jsx(n,{href:"#only-html"}),"."]}),`
`]}),`
...
`]}),`
`,e.jsx("h2",{id:"script",children:e.jsx("code",{children:"<script>"})}),`
`,e.jsxs(s.p,{children:["If you don't use Vue (e.g. React), you can use ",e.jsx(s.code,{children:"+Head"})," for adding ",e.jsx(s.code,{children:"<script>"})," tags to all your pages:"]}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"  return"}),e.jsx(s.span,{style:{color:"#24292E"},children:" <>"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"script"}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" type"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"text/javascript"'}),e.jsx(s.span,{style:{color:"#6F42C1"},children:" src"}),e.jsx(s.span,{style:{color:"#D73A49"},children:"="}),e.jsx(s.span,{style:{color:"#032F62"},children:'"https://example.com/some-script.js"'}),e.jsx(s.span,{style:{color:"#24292E"},children:"></"}),e.jsx(s.span,{style:{color:"#22863A"},children:"script"}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    <"}),e.jsx(s.span,{style:{color:"#22863A"},children:"script"}),e.jsx(s.span,{style:{color:"#24292E"},children:'>console.log("hello")</'}),e.jsx(s.span,{style:{color:"#22863A"},children:"script"}),e.jsx(s.span,{style:{color:"#24292E"},children:">"})]}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"  </>"})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(s.p,{children:["Adding a ",e.jsx(s.code,{children:"<script>"})," tag to only one/some pages isn't currently supported: ",e.jsxs(s.a,{href:"https://github.com/vikejs/vike/issues/2244",children:["#2244 - Add ",e.jsx(s.code,{children:"<script>"})," to only one/some pages"]}),"."]}),`
`,e.jsx("h3",{id:"vue",children:"Vue"}),`
`,e.jsxs(s.p,{children:["If you use Vue, ",e.jsxs(s.a,{href:"https://stackoverflow.com/questions/71430887/running-script-tags-within-template-on-vue-js/71442718#71442718",children:[e.jsx(s.code,{children:"<script>"})," tags cannot be defined inside Vue SFC ",e.jsx(s.code,{children:"<template>"})]}),". Instead use ",e.jsx(n,{href:"/useConfig",children:e.jsx(s.code,{children:"useConfig()"})}),":"]}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#D73A49"},children:"import"}),e.jsx(s.span,{style:{color:"#24292E"},children:" { h } "}),e.jsx(s.span,{style:{color:"#D73A49"},children:"from"}),e.jsx(s.span,{style:{color:"#032F62"},children:" 'vue'"})]}),`
...
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    type: "}),e.jsx(s.span,{style:{color:"#032F62"},children:"'text/javascript'"}),e.jsx(s.span,{style:{color:"#24292E"},children:","})]}),`
`,e.jsxs(s.span,{"data-line":"",children:[e.jsx(s.span,{style:{color:"#24292E"},children:"    src: "}),e.jsx(s.span,{style:{color:"#032F62"},children:"'https://example.com/some-script.js'"})]}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"  })"})}),`
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"})"})}),`
...
`,e.jsxs(s.p,{children:["See also: ",e.jsx(n,{href:"#how-to-inject-raw-html"})]}),`
`,e.jsx("h2",{id:"pagecontext",children:e.jsx("code",{children:"pageContext"})}),`
`,e.jsxs(s.p,{children:["You can access ",e.jsxs(n,{href:"/pageContext",children:["the ",e.jsx(s.code,{children:"pageContext"})," object"]})," by using ",e.jsx(n,{href:"/usePageContext",children:e.jsx(s.code,{children:"usePageContext()"})}),"."]}),`
`,e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"jsx","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"jsx","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// /pages/+Head.jsx"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsx("h3",{id:"vue",children:"Vue"}),`
`,e.jsxs(s.p,{children:["You can use ",e.jsx(n,{href:"/useConfig",children:e.jsx(s.code,{children:"useConfig()"})})," with Vue's ",e.jsx(s.code,{children:"innerHTML"})," to add raw HTML, for example:"]}),`
...
`,e.jsx(s.p,{children:e.jsx(s.strong,{children:"Only applies to the first page's HTML"})}),`
`,e.jsxs(s.p,{children:["The ",e.jsx(s.code,{children:"+Head"})," component is only rendered for the HTML of the first page the user visits: the tags set by ",e.jsx(s.code,{children:"+Head"})," aren't updated upon ",e.jsx(n,{href:"/client-routing",children:"client-side page navigation"}),"."]}),`
`,e.jsx("div",{style:{height:16}}),`
`,e.jsx(s.p,{children:e.jsx(s.strong,{children:"Limitation"})}),`
`,e.jsxs(s.p,{children:["The most notable limitation is that the ",e.jsx(s.code,{children:"+Head"})," setting cannot be used to set the value of the ",e.jsx(s.code,{children:"<title>"})," tag, because its value won't update when navigating to a page with a different title."]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsx(s.p,{children:"See the example below for a more detailed explanation."}),`
`]}),`
...
`]}),`
`,e.jsx("div",{style:{height:16}}),`
`,e.jsx(s.p,{children:e.jsx(s.strong,{children:"Only a small limitation"})}),`
...
`]}),`
`,e.jsxs(s.p,{children:["This isn't an issue for the ",e.jsx(s.code,{children:'<meta name="description">'}),` tag because it's intended for search engines bots which
