...
`]}),`
`]}),`
`,e.jsx(i,{children:e.jsxs(s.p,{children:["You may be tempted to use ",e.jsx(s.a,{href:"https://vitejs.dev/guide/features.html#glob-import",children:e.jsx(s.code,{children:"import.meta.glob()"})})," to retrieve the metadata of all pages, but we discourage this approach: loading all markdown files at once ",e.jsx(c,{}),"."]})}),`
...
`,e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#24292E"},children:"}"})})]})})}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["Unlike in the example ",e.jsx(n,{href:"#with-a-custom-setting",children:"below"})," you cannot define ",e.jsx(s.code,{children:"+metadata"})," inside ",e.jsx(s.code,{children:"+Page.mdx"}),", because ",e.jsx(s.code,{children:"+Page.mdx"})," is ",e.jsx(n,{href:"/lazy-transpiling",children:"only loaded when rendering that page"}),". Consequently, the content of ",e.jsx(s.code,{children:"+Page.mdx"})," isn't available when rendering another page."]}),`
`]}),`
