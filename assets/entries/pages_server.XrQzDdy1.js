import{o,a as t}from"../chunks/chunk-BxEkFozN.js";import{j as e}from"../chunks/chunk-BWBMLLro.js";import{L as n}from"../chunks/chunk-3WTzxuX3.js";/* empty css                      */import{W as c}from"../chunks/chunk-DseGLb9u.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{T as d,a as p,b as r,c as a}from"../chunks/chunk-BFP-d7ev.js";/* empty css                      *//* empty css                      *//* empty css                      */const h=[{pageSectionId:"add-vike-server-to-an-existing-vike-app",pageSectionLevel:2,pageSectionTitle:"Add `vike-server` to an existing Vike app"},{pageSectionId:"deployment",pageSectionLevel:2,pageSectionTitle:"Deployment"},{pageSectionId:"serve-options",pageSectionLevel:2,pageSectionTitle:"`serve()` options"},{pageSectionId:"custom-pagecontext",pageSectionLevel:2,pageSectionTitle:"Custom `pageContext`"},{pageSectionId:"standalone",pageSectionLevel:2,pageSectionTitle:"Standalone"},{pageSectionId:"hmr",pageSectionLevel:2,pageSectionTitle:"HMR"},{pageSectionId:"compression",pageSectionLevel:2,pageSectionTitle:"Compression"},{pageSectionId:"https",pageSectionLevel:2,pageSectionTitle:"HTTPS"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function i(l){const s={a:"a",blockquote:"blockquote",br:"br",code:"code",figure:"figure",li:"li",p:"p",pre:"pre",span:"span",ul:"ul",...l.components};return e.jsxs(e.Fragment,{children:[e.jsxs(s.p,{children:["To integrate Vike with a server, we recommend the ",e.jsx(s.code,{children:"vike-server"})," extension — it supports popular servers (Hono, Express, ...) and deployments (Cloudflare, Vercel, ...)."]}),`
...
`]}),`
`,e.jsxs(s.blockquote,{children:[`
`,e.jsxs(s.p,{children:["If you want more control over server integration, see ",e.jsx(n,{href:"/integration#server-manual-integration",children:"Server (manual integration)"}),"."]}),`
`]}),`
...
`,e.jsxs(d,{children:[e.jsxs(p,{children:[e.jsx(r,{children:"Hono"}),e.jsx(r,{children:"Express.js"}),e.jsx(r,{children:"Fastify"}),e.jsx(r,{children:"H3"}),e.jsx(r,{children:"Elysia"})]}),e.jsx(a,{children:e.jsx(s.figure,{"data-rehype-pretty-code-figure":"",children:e.jsx(s.pre,{style:{backgroundColor:"#fff",color:"#24292e"},tabIndex:"0","data-language":"js","data-theme":"github-light",children:e.jsxs(s.code,{"data-language":"js","data-theme":"github-light",style:{display:"grid"},children:[e.jsx(s.span,{"data-line":"",children:e.jsx(s.span,{style:{color:"#6A737D"},children:"// server/index.js"})}),`
`,e.jsx(s.span,{"data-line":"",children:" "}),`
