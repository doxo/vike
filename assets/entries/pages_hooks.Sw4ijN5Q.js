import{o as c,a as o}from"../chunks/chunk-BxEkFozN.js";import{j as e}from"../chunks/chunk-BWBMLLro.js";import{L as r}from"../chunks/chunk-3WTzxuX3.js";/* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      *//* empty css                      */import{U as t}from"../chunks/chunk-DfQe0O1c.js";/* empty css                      *//* empty css                      *//* empty css                      */function l({children:d,style:n}){return e.jsx("span",{style:{color:"#888",fontSize:"0.94em",verticalAlign:"middle",...n},children:d})}function i({children:d}){return e.jsx(l,{style:{fontWeight:600},children:d})}const h=[{pageSectionId:"basics",pageSectionLevel:2,pageSectionTitle:"Basics"},{pageSectionId:"advanced",pageSectionLevel:2,pageSectionTitle:"Advanced"},{pageSectionId:"upcoming",pageSectionLevel:2,pageSectionTitle:"Upcoming"},{pageSectionId:"lifecycle",pageSectionLevel:2,pageSectionTitle:"Lifecycle"},{pageSectionId:"default",pageSectionLevel:3,pageSectionTitle:"Default"},{pageSectionId:"client-side-only-data",pageSectionLevel:3,pageSectionTitle:"Client-side only `data()`"},{pageSectionId:"see-also",pageSectionLevel:2,pageSectionTitle:"See also"}];function s(d){const n={a:"a",blockquote:"blockquote",code:"code",em:"em",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...d.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:["List of built-in hooks. (You can ",e.jsx(r,{href:"/meta",children:"create your own"}),".)"]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/onBeforePrerenderStart",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"onBeforePrerenderStart()"})})}),": ",e.jsx(l,{children:"server"})," Called before the whole ",e.jsx(r,{href:"/pre-rendering",children:"Pre-rendering"})," process starts."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/onPrerenderStart",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"onPrerenderStart()"})})}),": ",e.jsx(l,{children:"server"})," Global hook called when ",e.jsx(r,{href:"/pre-rendering",children:"Pre-rendering"})," starts."]}),`
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"vike-vue"})})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/onCreateApp",children:e.jsx(n.strong,{children:e.jsx(n.code,{children:"onCreateApp()"})})}),": ",e.jsx(l,{children:"server & client"})," ",e.jsx(r,{href:"/vike-vue",children:e.jsx(n.code,{children:"vike-vue"})})," Called after creating Vue's ",e.jsx(n.code,{children:"app"})," instance."]}),`
`]}),`
...
`,e.jsx(r,{href:"/pageContext#lifecycle"}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsx(r,{href:"/globalContext#lifecycle"}),`
`]}),`
`]}),`
`]}),`
`,e.jsx(n.p,{children:"The order in which the hooks are called (the hook flow)."}),`
`,e.jsxs(n.blockquote,{children:[`
...
`,e.jsx(r,{href:"/config"}),`
`]}),`
`]})]})}function x(d={}){const{wrapper:n}=d.components||{};return n?e.jsx(n,{...d,children:e.jsx(s,{...d})}):s(d)}const a=Object.freeze(Object.defineProperty({__proto__:null,default:x,pageSectionsExport:h},Symbol.toStringTag,{value:"Module"})),B={isClientRuntimeLoaded:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:!0}},onBeforeRenderEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},dataEnv:{type:"computed",definedAtData:null,valueSerialized:{type:"js-serialized",value:null}},onRenderClient:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/renderer/onRenderClient",fileExportPathToShowToUser:[]},valueSerialized:{type:"pointer-import",value:o}},onCreatePageContext:{type:"cumulative",definedAtData:[{filePathToShowToUser:"@brillout/docpress/renderer/onCreatePageContext",fileExportPathToShowToUser:[]}],valueSerialized:[{type:"pointer-import",value:c}]},Page:{type:"standard",definedAtData:{filePathToShowToUser:"/pages/hooks/+Page.mdx",fileExportPathToShowToUser:[]},valueSerialized:{type:"plus-file",exportValues:a}},hydrationCanBeAborted:{type:"standard",definedAtData:{filePathToShowToUser:"@brillout/docpress/config",fileExportPathToShowToUser:["default","hydrationCanBeAborted"]},valueSerialized:{type:"js-serialized",value:!0}}};export{B as configValuesSerialized};
